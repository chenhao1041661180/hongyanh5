...
function navigationByAndroid(destination){
	console.log("====== navigationByAndroid  ======");
	let destinationName = destination.name?destination.name:"终点";
	...
	var bdappDown = "http://map.baidu.com/zt/qudao/newfengchao/1012337a/html/slide.html"
	var amapuri = "androidamap://navi?sourceApplication=amap&lat="+destination.latitude+"&lon="+destination.longitude+"&poiname="+destinationName+"&dev=1";
	var amapuriDown = "http://wap.amap.com/";
	...
	plus.nativeUI.actionSheet(
		...
		function(res){
			console.log("====== navigationByAndroid 888 ======");

			if(isBaidu && isGaode){
				if(res.index == 1){
					console.log("====== navigationByAndroid11  ======");
					appOpenUrl(bdapp);
				}else if(res.index ==2){
					console.log("====== navigationByAndroid22  ======");
				...
				if(res.index == 1){
					console.log("====== navigationByAndroid 9999  ======");
