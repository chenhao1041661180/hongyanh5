<template>
  <view class="u-input" :class="{
    ...
    <textarea v-if="type == 'textarea'" class="u-input__input u-input__textarea" :style="[getStyle]"
      ...
      :maxlength="inputMaxlength" :fixed="fixed" :focus="focus" :autoHeight="autoHeight" :selection-end="uSelectionEnd"
      :selection-start="uSelectionStart" :cursor-spacing="getCursorSpacing" :show-confirm-bar="showConfirmbar"
    ...
    <view class="u-input__right-icon u-flex">
      ...
      <view class="u-input__right-icon--select u-input__right-icon__item" v-if="type == 'select'" :class="{
        ...
        <u-icon :name="arrowIcon" size="26" color="#c0c4cc" :custom-prefix="customPrefix"></u-icon>
      </view>
    </view>
  </view>
</template>
