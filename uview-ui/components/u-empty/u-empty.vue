<template>
    ...
    <image src="../../../static/images/default_no_data.png" style="height: 183rpx;" :style="{'width':imgWidth+'rpx'}"></image>
    <text :style="{color:color,'font-size':fontSize+'rpx','margin-top':'14rpx'}">{{text}}</text>
