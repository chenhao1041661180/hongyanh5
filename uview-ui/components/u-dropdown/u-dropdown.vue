<template>
	<view class="u-dropdown">
		<view class="u-dropdown__menu" :style="{
			...
			<view class="u-dropdown__menu__item" v-for="(item, index) in menuList" :key="index" @tap.stop="menuClick(item,index)">
				<view class="u-flex">
		...
		<view v-show="showMask" class="u-dropdown__content" :style="[contentStyle, {
