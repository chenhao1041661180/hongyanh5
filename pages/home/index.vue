<template>
  <view style="position: relative;">
    ...
    <view style="padding-top: 33rpx;padding-bottom: 24rpx; display: flex;text-align: center;align-items: center;">
      <image
        src="../../static/images/ic_baokuan.png"
        style="width: 34rpx;height: 34rpx;margin-left: 24rpx;"
      />
    ...
    <view
      class="customer-service-view"
      @click="showCallPopup"
    >
      <image
        src="../../static/images/btn_kefudianhua.png"
        style="width: 100rpx;height: 100rpx;"
      />
    </view>
    <customer-phonenumber-popup
      ref="callPopup"
      :show="showCall"
    />
  </view>
